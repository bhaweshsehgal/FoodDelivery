...
class ChowDao {
 ...
 async addOrder(eateries){
 console.log(eateries.total);
 const myeatery=await this.getEatery(eateries.eateryId);
 myeatery['total']=eateries.total;
 const eatery1=await this._eateries.replaceOne({_id:myeatery['id']}, myeatery);
 //console.log(eatery1);
 }
